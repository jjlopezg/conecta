...
class HrEmployeeBenefitRate(models.Model):
    ...
    def get_all_amount_types(self):
        ...
        Obtener la lista de tipos cantidad de beneficios a los empleados
         Este método no se llama directamente de modo que pueda ser heredada
         fácilmente en otros módulos. Cuando la herencia de este método, la lista
         de selecciones se actualiza en todos los modelos relacionados.
        """
        return [
            ('each_pay', _('Each Pay')),
            ('annual', _('Annual')),
